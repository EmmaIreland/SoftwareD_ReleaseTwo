...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link controller="project" class="list" action="list"><g:message code="Project List" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
            <h1><g:message code="Add Student to Group" args="[entityName]" /></h1>
