                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${groupAssignmentInstance?.student?.id}">${groupAssignmentInstance?.student?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="groupAssignment.team.label" default="Team" /></td>
                            
                            <td valign="top" class="value"><g:link controller="team" action="show" id="${groupAssignmentInstance?.team?.id}">${groupAssignmentInstance?.team?.encodeAsHTML()}</g:link></td>
