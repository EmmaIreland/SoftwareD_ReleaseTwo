...
<g:link controller="project" action="create" params="['course.id': courseInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'project.label', default: 'Project')])}</g:link>
                ...
                <div class="buttons">
                    ...
                    <span class="button"><g:actionSubmit class="show" action="show" value="${message(code: 'default.button.label', default: 'Cancel')}" onclick="return confirm('${message(code: 'default.button.confirm.message', default: 'Cancel Changes Made?')}');"/></span>
                </div>
            </g:form>
        </div>
    </body>
