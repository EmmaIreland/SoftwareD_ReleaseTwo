                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: enrollmentInstance, field: 'student', 'errors')}">
                                    <g:select name="student.id" from="${surveyor.User.list()}" optionKey="id" value="${enrollmentInstance?.student?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: enrollmentInstance, field: 'course', 'errors')}">
                                    <g:select name="course.id" from="${surveyor.Course.list()}" optionKey="id" value="${enrollmentInstance?.course?.id}"  />
                                </td>
                            </tr>
